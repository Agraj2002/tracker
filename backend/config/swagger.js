...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'A comprehensive API for managing personal finances with user authentication, role-based access control, and analytics.',
      contact: {
        name: 'API Support',
    ...
    servers: [
      {
        url: process.env.NODE_ENV === 'production' 
          ? `${process.env.RENDER_EXTERNAL_URL || 'https://finance-tracker-api.onrender.com'}/api`
